...
export const spinnerIconSpin = <i className="fa-solid fa-spinner fa-spin"></i>
...
export const circleNotch = <i className="fa-solid fa-circle-notch"></i>
export const circleNotchSpin = <i className="fa-solid fa-circle-notch fa-spin"></i>
