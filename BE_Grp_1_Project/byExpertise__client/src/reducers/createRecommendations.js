...
export const Actions = {
  ...
  CLEAR_CREATE_RECOMMENDATION_ERROR: CLEAR_CREATE_RECOMMENDATION_ERROR,
};
...
export const createRecommendation = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case Actions.CREATE_RECOMMENDATION_ERROR:
      return {
        ...state,
    ...
    case Actions.CLEAR_CREATE_RECOMMENDATION_ERROR:
      return {
        ...state,
        error: null,
      };
